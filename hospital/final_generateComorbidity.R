...
Data_Comorbidity <- fread(paste('D:/BIG DATA/Prof Yehh/DOC/Result/QualifiedData.csv', sep=""), header = T, sep = ',', verbose=F, colClasses = "character")
...
nrow(Data_Comorbidity[as.integer(Data_Comorbidity$Diabetes) == 0 & as.integer(Data_Comorbidity$Stroke) == 0 & as.integer(Data_Comorbidity$MI) == 0 & as.integer(Data_Comorbidity$DiabetesMI) == 0 & as.integer(Data_Comorbidity$DiabetesStroke)==0 & as.integer(Data_Comorbidity$StrokeMI)==0 & as.integer(Data_Comorbidity$DiabetesStrokeMI)==0])
