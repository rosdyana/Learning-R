...
#==========================================================================================================================================
PATIENT_IABLE_RESULT <- fread(paste('D:/BIG DATA/Prof Yehh/DOC/Result/2.PateintWith_AgeOfInitialInclusionData.csv', sep=""), header = T, sep = ',', verbose=F, colClasses = "character")
...
readData <- fread(paste('D:/BIG DATA/Prof Yehh/DOC/Result/4.PatientResultwith_BP.csv', sep=""), header = T, sep = ',', verbose=F, colClasses = "character")
